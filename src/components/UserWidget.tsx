    ...
    <>
      <SignedIn>
        <Menu as="div" className="relative inline-block text-left">
          ...
          >
            <Menu.Items className="absolute bg-base-100 right-0 mt-3 w-56 origin-top-right divide-y divide-primary rounded-md border border-primary ring-1 ring-black ring-opacity-5 focus:outline-none">
