...
const PrivacyPage: NextPage = () => {
  return (
    <>
      ...
      <Title type="section" title="Interpretation and Definitions" />
      <Title type="subsection" title="Interpretation" />
      <p>
      ...
      <Title type="subsection" title="Definitions" />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SmartApply.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SmartApply, accessible from{" "}
            <Link
              className="link-hover link-primary link"
              href="https://www.smartapply.app"
            >
              https://www.smartapply.app
            </Link>
          </p>
        </li>
        <li>
      ...
      <Title type="section" title="Collecting and Using Your Personal Data" />
      <Title type="subsection" title="Types of Data Collected" />
      <h4 className="my-2 font-semibold">Personal Data</h4>
      <p>
      ...
      <h4 className="my-2 font-semibold">Usage Data</h4>
      ...
      <h4 className="my-2 font-semibold">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <Title type="subsection" title="Use of Your Personal Data" />
      ...
      <Title type="subsection" title="Retention of Your Personal Data" />
      <p>
      ...
      <Title type="subsection" title="Transfer of Your Personal Data" />
      <p>
      ...
      <Title type="subsection" title="Delete Your Personal Data" />
      <p>
      ...
      <Title type="subsection" title="Disclosure of Your Personal Data" />
      <h4 className="my-2 font-semibold">Business Transactions</h4>
      <p>
      ...
      <h4 className="my-2 font-semibold">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="my-2 font-semibold">Other legal requirements</h4>
      <p>
      ...
      <Title type="subsection" title="Security of Your Personal Data" />
      <p>
      ...
      <Title type="section" title="Children's Privacy" />
      <p>
      ...
      <Title type="section" title="Links to Other Websites" />
      <p>
      ...
      <Title type="section" title="Changes to this Privacy Policy" />
      <p>
